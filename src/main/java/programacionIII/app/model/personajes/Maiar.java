...
public class Maiar extends Personaje {
    public Maiar(String nombre, LocalDate fecha, Raza raza, int velocidad, int destreza, int fuerza, int nivel, int armadura, int edad) {
